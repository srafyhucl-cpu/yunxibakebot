...
- evidence_type: governance/accounting-contract-d1a1-runtime-remediation
- file: git:4596d7e:LOGBOOK.md；git:4596d7e:VERSION；git:4596d7e:项目进度与配置清单.md；git:4596d7e:docs/harness-engineering/adr/0008-accounting-core-consistency.md；git:4596d7e:docs/specs/2026-08-16-accounting-d1a-runtime-remediation.md；git:4596d7e:app/service/payment/errors.py；git:4596d7e:app/service/payment/unified.py；git:4596d7e:app/service/points/payment.py；git:4596d7e:app/service/stored_value/payment.py；git:4596d7e:app/repository/points_refund_reconcile_repo.py；git:4596d7e:scripts/check_project.py；git:4596d7e:scripts/check_file_sizes.py；git:4596d7e:tests/service/test_payment_attempt_d1a.py；git:4596d7e:tests/service/test_points_payment.py；git:4596d7e:tests/service/test_coupon_payment.py；local:reports/harness/handoff-d1a1-runtime-20260816.md
- commit_sha: 4596d7e
- command: `git push origin/server HEAD:codex/r4c-ci-evidence` + `git ls-remote` 复核（审阅分支双远端均本归档提交，master 双远端保持 `b30b2066`）；**pre-commit 13 项 hook_id=status 清单（内容提交 4596d7e，D1-A.1 证据格式）**：detect-secrets=Passed；verify-secrets-baseline=Passed；sync-version=Passed（代码变更 patch 递增 0.132.12→0.132.13，进度清单表头注入）；check-logbook=Passed；check-file-sizes=Passed（unified.py / stored_value/payment.py 职责评审注记更新至 D1-A.1）；check-project=Passed（含「合同文档旧口径守卫」+「D1-0 直接写状态守卫」（显式写方法补 ensure_open_case））；check-redline-selftest=Passed；check-mistake-ledger=Passed；check-evidence-index=Passed（本条目加入前）；check-text-encoding=Passed；ruff-check=Passed；ruff-format-check=Passed；mypy=Passed——**13 项全部 Passed（ruff 两项因 .py 已暂存而生效，非跳过）**；`python scripts/check_evidence_index.py --summary`（E-012 加入后实测，sha256 映射与 `git cat-file` blob 一致，total/failed/verified_files 见 summary 下方）；`python -m pytest -q --no-cov -p no:cacheprovider --basetemp=D:\Temp\pytest-outside-repo-d1a`（**全量 exit=0**）；`python scripts/check_project.py --skip-tests`（质量门禁通过，含 D1-0 守卫 passed=True）；定向套件（全绿）：test_payment_attempt_d1a（24 项：原 16 + R1 失败→重试→取消 held 归零 / R2 余额支付 outbox 可还原完整计划 / R3 结算+退款 legacy_unbound 不写新账户 / R4 案件关闭后复发必为 open 版本递增 / R5 积分余额不足→manual_review + CAS 落空显式冲突 / v027 回填守卫）、test_points_payment（种子绑定不可变账户 ID 与真实流程对齐 + unbound/bind_id 逃生口）、test_coupon_payment（预占失败语义）、test_stored_value、test_order；`git diff --check`（仅 LF→CRLF 提示）；ruff check/format、mypy（改动文件作用域无新增错误，剩余 186 项为未触碰文件基线）；`python scripts/check_file_sizes.py`（职责评审注记更新）；环境性失败排除：tests/scripts/test_local_production_backup.py（备份目录必须位于 C 盘）与 test_run_isolated_remediation_harness.py 在默认 pytest tmp（非 C 盘）下失败，协议 `--basetemp` 下全部通过——与本次改动无关
- result: pass
- related_logbook: 2026-08-16 - docs(governance): D1-A.1 复核代码整改包（R1–R6 六项高优运行时缺口，方案 B，验收固定五项）
...
- sha256: LOGBOOK.md=59838caa09cf513ec9f60fd64703b2ab6f669b2037121ca83d0f059b9b6c8f5e；VERSION=2e830144b565e58defd4a6dbb6829afc37b09260946729e1646858c67b760ca6；项目进度与配置清单.md=a912b1041f17ad526bc5f73134e0aa1198673e24ba815fd52ef59b31cfb1be2b；docs/harness-engineering/adr/0008-accounting-core-consistency.md=7772e378cb4cf4a222b141d752263ba5b88d1bbab9e5a5f5764299210c75bd63；docs/specs/2026-08-16-accounting-d1a-runtime-remediation.md=c056f6c53efeb641ffc298feb5c02b5b0cb06dcbf8ceed9d330d47be90a9b128；app/service/payment/errors.py=1295e3fd154515b69e9342c955ab142794382b4a432638e62e507ee8cde1cdff；app/service/payment/unified.py=823f89f256db7728e7d44aa12e727d9ebe361902a26ce79b451182a961d6e534；app/service/points/payment.py=b7bc57742eea160f14a1923f02b56512696c680adcddbfda845e3e6750f2579c；app/service/stored_value/payment.py=e4c23cb7bc254ad6980663917362dc68bf4e7b6b3c40da439a38647fb5f8ba47；app/repository/points_refund_reconcile_repo.py=a5e671ecc07cd57fcdf1a2f39e80284f5ff3361905f3c72f67a18821b67f4d0f；scripts/check_project.py=a407f864a37e16b09a5bb3004843f23ac22266d864cbbb23e3b315bfa19ee1c4；scripts/check_file_sizes.py=97639c7c0049be327b1a7fda18f8c5f1f298b30d79206f60e2953459390d821b；tests/service/test_payment_attempt_d1a.py=d4e1665df82072c30d6eb1b796a799a1953fbd8c9247cc2991014d724aa89ddb；tests/service/test_points_payment.py=3cbb3e285ae69843af268f087f0aa2d8224472a564bc6f81888746225203d4df；tests/service/test_coupon_payment.py=3a10313617ccd353aec37d1d8722a897be8117798d8e390fc76d73e40806e060
- summary: D1-A.1 复核代码整改包（项目负责人对 d438bc0 复核 Go/No-Go=暂不通过、方案 B，验收固定五项：①同订单重试无预占泄漏 ②余额支付 outbox 可还原完整计划 ③历史无账户 ID 不写新账户 ④案件关闭后复发必为 open ⑤CAS 落空可见且可处理）：R1 hold_key 改 attempt 维度 `hold:{payment_attempt_id}:{asset}` + reserve 落空回滚本腿预占并整体阻断（同订单失败→重试→取消 held 归零）；R2 创建 attempt 前落库规范支付计划（method=balance/balanceFen/totalFen/currency=CNY/memberBalanceId/planVersion=1），attempt 快照/hash/outbox 只引用该计划，provider 不再退化 mock；R3 禁止按手机号补绑（结算遇未绑定快照 → PaymentAccountError(code="legacy_unbound") → manual_review，退款账户仅回退不可变结算事实 ledger:settle_redeem，再无则 account_missing 案件/欠账，不写重建新账户）；R4 PointsRefundReconcileRepo.ensure_open_case（closed→open 版本递增 reopen → 新建幂等 → 确认为 open），_open_case_and_review 与全部退款案件写点接入，案件+attempt 同一专用 UoW；R5 新增 app/service/payment/errors.py::PaymentAccountError(code,message)，结算/预占分流改 isinstance（账户型→manual_review、预占不足→failed 契约不变），_commit_attempt_state(attempt_id,coro) 检查 CAS 结果、落空重读仅接受已知幂等终态否则显式并发冲突。R6 组合支付微信通知仍直接 mark_paid 绕过统一服务（余额 hold 不消费/释放、无结算 outbox）——**D1-C 硬门槛，本轮不改代码**，与 P8 outbox fencing 并列 D1-C 必须项。master 双远端保持 b30b2066 直至项目负责人按固定五项验收复核放行；order.payment 仍为展示缓存（降级为引用是 D1-B 范围）；POINTS_DEDUCTION_FENCE 保持 True；2027-05-31 开发测试边界不变。



- trace_id: 20260816-accounting-d1a-runtime-remediation
- generated_at: 2026-08-16
- evidence_type: governance/accounting-contract-d1a-runtime-remediation
- file: git:5bc022e:LOGBOOK.md；git:5bc022e:VERSION；git:5bc022e:项目进度与配置清单.md；git:5bc022e:docs/harness-engineering/adr/0008-accounting-core-consistency.md；git:5bc022e:docs/specs/2026-08-16-accounting-d1a-minimal-slice.md；git:5bc022e:docs/specs/2026-08-16-accounting-d1a-runtime-remediation.md；git:5bc022e:app/migrations/v027_accounting_d1a.sql；git:5bc022e:app/repository/member_balance_repo.py；git:5bc022e:app/repository/payment_attempt_repo.py；git:5bc022e:app/service/order/application.py；git:5bc022e:app/service/order/payment_runtime.py；git:5bc022e:app/service/payment/unified.py；git:5bc022e:app/service/points/payment.py；git:5bc022e:app/service/stored_value/member.py；git:5bc022e:app/service/stored_value/payment.py；git:5bc022e:scripts/check_project.py；git:5bc022e:scripts/check_file_sizes.py；git:5bc022e:tests/service/test_payment_attempt_d1a.py；git:5bc022e:tests/service/test_stored_value.py；local:reports/harness/handoff-d1a-runtime-20260816.md
- commit_sha: 5bc022e
- command: `git push origin/server HEAD:codex/r4c-ci-evidence` + `git ls-remote` 复核（审阅分支双远端均本归档提交，master 双远端保持 `b30b2066`）；**pre-commit 13 项 hook_id=status 清单（内容提交 5bc022e，amend 版本号引用修正）**：detect-secrets=Passed；verify-secrets-baseline=Passed；sync-version=Passed（代码变更 patch 递增 0.132.10→0.132.12：首次提交尝试被文件体量守卫阻断时已递增至 0.132.11，补登记 unified.py/stored_value/payment.py 职责评审后正式提交再递增至 0.132.12，进度清单表头注入）；check-logbook=Passed；check-file-sizes=Passed（unified.py 560 行 / stored_value/payment.py 332 行职责评审登记）；check-project=Passed（含「合同文档旧口径守卫」+「D1-0 直接写状态守卫」（unified.py 方法级 allowlist 增补内部写点、member.py {credit_by_id, deduct_by_id}、显式写方法补 mark_failed_preclaim/reserve_points/reserve_stored_value_fen/clear_points_hold/clear_stored_value_fen_hold））；check-redline-selftest=Passed；check-mistake-ledger=Passed；check-evidence-index=Passed（本条目加入前）；check-text-encoding=Passed；ruff-check=Passed；ruff-format-check=Passed；mypy=Passed——**13 项全部 Passed（amend 轮 ruff 两项因无 .py 暂存 Skipped，正式提交轮因 .py 已暂存而生效）**；`python scripts/check_evidence_index.py --summary`（E-011 加入后实测，sha256 映射与 `git cat-file` blob 一致）；`python -m pytest -q --no-cov -p no:cacheprovider --basetemp=D:\Temp\pytest-outside-repo-d1a`（**全量 exit=0**）；定向套件：test_payment_attempt_d1a（16 项：A1–A6 + P1 公开路径失败→settling_retry→修复重放、P3 双订单超预占+释放后重预占（账户行 held 断言）、P4 计划变更 open_case+manual_review+outbox attempt 快照载荷、P5 manual_review 矩阵两用例、P6 实际入账/全额 settle_award 事实/债务 remaining 对账、P7 回填仅 open 行为+迁移文本守卫）/ test_stored_value（P2/P3 语义：预占不扣减、结算才扣减、取消释放预占）/ test_points_payment / test_order / test_coupon_payment 全部通过；D1-0 守卫 passed=True（run_migration_guard_checks）；`git diff --check`（仅 LF→CRLF 提示）；ruff check/format、mypy（改动文件作用域无新增错误，剩余 38 项为未触碰文件基线）；`python scripts/check_file_sizes.py`（411 文件 OK，新增两项职责评审登记）；环境性失败排除：tests/scripts/test_local_production_backup.py（备份目录必须位于 C 盘）与 test_run_isolated_remediation_harness.py 在默认 pytest tmp（非 C 盘）下失败，协议 `--basetemp` 下全部通过——与本次改动无关
- result: pass
- related_logbook: 2026-08-16 - docs(governance): D1-A 运行时整改包（复核 P1–P7 聚焦整改，方案 B，不改写已归档提交）
- related_adr: 0008-accounting-core-consistency
- contains_sensitive_data: no
- retention_note: 只记录验证命令、hook 状态清单、条目数与守卫结论；不含密钥、客户数据或订单明细。
- storage_scope: repository
- sha256: LOGBOOK.md=47db2464d38e76fade11949a38663ee0bdba9fd81929e4105aab9ef1cceae51c；VERSION=e0061e6c4e2b457352a80f15a44af70cc2ba67e8e2951825e0cae7b940806d45；项目进度与配置清单.md=7f23637844b80466d9d61a8b445be9704767be88f5f7ef472a4bdb4bc8ec4fc2；docs/harness-engineering/adr/0008-accounting-core-consistency.md=cb93ec2e0c9733465be89f43f07afdfe0a2c6875e43aea86b711f52ce93765dd；docs/specs/2026-08-16-accounting-d1a-minimal-slice.md=01a05db779249fcd5b91a87c175a027938d56de09eca5f87fd13d3bbc9ad73e3；docs/specs/2026-08-16-accounting-d1a-runtime-remediation.md=f5b728da6eba1c0cb7a27b33bc6cf28adfa76a4da200ee5f1d4e4b0a361e606c；app/migrations/v027_accounting_d1a.sql=cf5fdf42ff480c8ac9d0e9dcbd604fb0e10bb8fd66bf620513fb23b311ac2c3a；app/repository/member_balance_repo.py=65605a4519deaa122c8501ba7be8915ecb231e9b5dd20c91af5b05f02e0a7081；app/repository/payment_attempt_repo.py=06bea584f9a74038060b5efd2174554dfab24c1ad40a73ffb8753114e8384328；app/service/order/application.py=6020447b3ab107a46f47831925f3686d0b0da6033f48cec5714ae9804ae37e93；app/service/order/payment_runtime.py=635dc611c6be16321a4298acb917ac7f95a5677476604e58c5218bc19061b861；app/service/payment/unified.py=c5a9e562eaff593fe2f0bf5c4ac038074683824fbb02ce380d3960695a1c978d；app/service/points/payment.py=1cfa35c216621bb185d97b46e2edfb0adc5048735c0b5e2ed92d45a96624154e；app/service/stored_value/member.py=e2593e95b5acd3c61326ddb5729a45ed42fb86504f4e165caba399c675202fe3；app/service/stored_value/payment.py=3bb85dd8e2e578526322d0a0ab17c2d63e976e2d58fbd99bb46561b421778b4a；scripts/check_project.py=f6904f6b63166c25959202256c98abf1d08903972e4266d39506eb41fd3451d2；scripts/check_file_sizes.py=599cb3d407817c04afa1fcded0da9faadad4896cde7740fad7c1be2a78aebf40；tests/service/test_payment_attempt_d1a.py=f108f9194ab01617db2bb93c2db28e2a5821c8708ac25f0b67a66ff8bebf49ee；tests/service/test_stored_value.py=fc60bc9e4f63188977be2f4976998d518520e88478eed7aa0e730369d1a56fec
- summary: D1-A 运行时整改包（项目负责人复核 Go/No-Go=暂不通过、方案 B，不改写 69a31c9/6c2b2a0）：P1 两阶段结算（预占自有 UoW 提交 + 结算独立事务，失败回滚资产副作用后以重读 state_version 持久化 settling_retry/manual_review 再抛；confirm_mock_payment 不再包外层事务；mark_retry WHERE 扩为 prepay_ready/settling_retry）；P2 储值账户身份（resolve_member_balance_id 首次储值操作即固定；pay_order_with_balance 先写 memberBalanceId 再重读订单；组合支付预占即绑定；未绑定退款债务化）；P3 账户行真实预占（member_balance 增 held_points/held_stored_value_fen，可用额=余额−预占，原子 reserve/clear 条件 UPDATE）；P4 attempt 快照校验（snapshot_hash+腿金额 → open_case(plan_changed)+manual_review 阻断；outbox 载荷=attempt 不可变快照+结果）；P5 manual_review 矩阵（paid→仅可人工结案禁止释放；未付→可释放）；P6 可对账事实（points_ledger 记实际入账、全量 award 事实 ledger:settle_award:<id>、偿债独立 ledger_operation、_repay_open_debts 只偿 :clawback 键）；P7 v027 回填限定 open；串行化写锁（无操作 UPDATE orders 先行，修复 WAL+deferred 下 UNIQUE 索引 COMMIT 不复查导致的双尝试）。P8 outbox fencing 不阻断本轮、D1-C 前必须实现；master 双远端保持 b30b2066 直至项目负责人固定范围复核放行；order.payment 仍为展示缓存（降级为引用是 D1-B 范围）；POINTS_DEDUCTION_FENCE 保持 True；2027-05-31 开发测试边界不变。

## E-20260816-010：D1-A 最小资金核心纵向切片开发测试治理校验

- trace_id: 20260816-member-loyalty-accounting-contract-d1a
- generated_at: 2026-08-16
- evidence_type: governance/accounting-contract-d1a
- file: git:69a31c98333a49001033d1f791510e800e72beb8:LOGBOOK.md；git:69a31c98333a49001033d1f791510e800e72beb8:VERSION；git:69a31c98333a49001033d1f791510e800e72beb8:项目进度与配置清单.md；git:69a31c98333a49001033d1f791510e800e72beb8:docs/harness-engineering/adr/0008-accounting-core-consistency.md；git:69a31c98333a49001033d1f791510e800e72beb8:docs/specs/2026-08-16-accounting-d1a-minimal-slice.md；git:69a31c98333a49001033d1f791510e800e72beb8:app/migrations/v027_accounting_d1a.sql；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/payment_attempt_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/account_hold_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/accounting_outbox_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/member_balance_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/refund_shortfall_debt_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/repository/ledger_operation_repo.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/payment/unified.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/points/ledger.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/points/payment.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/order/payment_runtime.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/order/cancellation.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/order/status_flow.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/order/expiration.py；git:69a31c98333a49001033d1f791510e800e72beb8:app/service/stored_value/payment.py；git:69a31c98333a49001033d1f791510e800e72beb8:scripts/check_project.py；git:69a31c98333a49001033d1f791510e800e72beb8:scripts/check_file_sizes.py；git:69a31c98333a49001033d1f791510e800e72beb8:tests/service/test_payment_attempt_d1a.py；git:69a31c98333a49001033d1f791510e800e72beb8:tests/service/test_points_payment.py；local:reports/harness/handoff-d1a-minimal-slice-20260816.md
- commit_sha: 69a31c98333a49001033d1f791510e800e72beb8
- command: \git push origin/server HEAD:codex/r4c-ci-evidence\ + \git ls-remote\ 复核（审阅分支双远端均 D1-A 归档提交，master 双远端保持 \30b2066\）；**pre-commit 13 项 hook_id=status 清单（内容提交 69a31c9，B3.5 证据格式）**：detect-secrets=Passed；verify-secrets-baseline=Passed；sync-version=Passed（代码变更 patch 递增 0.132.9→0.132.10，进度清单表头注入）；check-logbook=Passed；check-file-sizes=Passed（member_balance_repo.py 增职责评审登记）；check-project=Passed（含「合同文档旧口径守卫」+「D1-0 直接写状态守卫」（AST 方法级 allowlist，unified.py 登记 19 模块 + 显式写方法补全 + 闭包归外层方法修复））；check-redline-selftest=Passed；check-mistake-ledger=Passed；check-evidence-index=Passed（本条目加入前）；check-text-encoding=Passed；ruff-check=Passed；ruff-format-check=Passed；mypy=Passed——**13 项全部 Passed（ruff 两项因 .py 已暂存而生效，非跳过）**；\python scripts/check_evidence_index.py --summary\（E-010 加入后实测，sha256 映射与 \git cat-file\ blob 一致）；\python -m pytest tests/ --no-cov\（**1520 项全过**（B3.5 基线 1511 + D1-A 新增 9），仓库外 \--basetemp=D:\Temp\pytest-outside-repo-d1a\，\--ignore=tests/scripts/test_verify_secrets_baseline.py\ 环境性基线 10 项，全量含基线 1530 项；get_active 改造后全量复跑 exit=0）；定向套件：test_payment_attempt_d1a（9 项 A1–A6）/ test_points_payment（26，含短口债务删除账户语义与双连接幂等契约放宽）/ test_coupon_payment / test_stored_value / test_order / test_member_accounting / test_miniapp_payment_api / test_admin_coupons_api / test_inbox_repo / test_webhook_dispatcher / test_webhook_retry / test_check_project 全部通过；\python scripts/check_file_sizes.py\（411 文件 OK，member_balance_repo.py 职责评审登记）；\python scripts/check_project.py --skip-tests\（质量门禁通过，含 D1-0 守卫 passed=True）；\python -m ruff check\ / \python -m ruff format --check\（改动文件）通过；\python -m mypy\（改动文件作用域无新增错误，payment_runtime/stored_value Optional 收窄已修复）；\git diff --check\（仅 LF→CRLF 提示）
- result: pass
- related_logbook: 2026-08-16 - docs(governance): D1-A 最小资金核心纵向切片（mock 订单预占/结算/取消释放/重放 + 不可变账户 ID 与债务闭环）
- related_adr: 0008-accounting-core-consistency
- contains_sensitive_data: no
- retention_note: 只记录验证命令、hook 状态清单、条目数与守卫结论；不含密钥、客户数据或订单明细。
- storage_scope: repository
- sha256: LOGBOOK.md=7256ffb4bb5d022a5cebed2c0b1a27d79ff00f990d75d59d5dd2891fd2c704f6；VERSION=a783439a363c059cd9fff91355636e70dc86083e246880d79beec5462ac39acd；项目进度与配置清单.md=312b2b2962c78539e3cf089cc4e631114bd854270827adf8f4286e09216c5aee；docs/harness-engineering/adr/0008-accounting-core-consistency.md=60d178455cca43fa6374a042dee9d3c99ea837afa903eddd75fe54d6e6b67aec；docs/specs/2026-08-16-accounting-d1a-minimal-slice.md=d0091a27c40a1fe475fcefb5d61d0a9facec223e8383e9e1711aa30479088fca；app/migrations/v027_accounting_d1a.sql=54ddca765604db2d60b1ee39fa44c4f20acaa03b5995e7b85fc3534597bb20c2；app/repository/payment_attempt_repo.py=3813deca42ae1b6dd55ce3c0524757406231611977813101591c833c2a87a34e；app/repository/account_hold_repo.py=0f9af6da21c236e956f48001ac49075e51705d8f7dd1b2e2f06ba3ff74b9846b；app/repository/accounting_outbox_repo.py=d1055cff2175c75a45ad23b52d5a7d7889e1cdaa6a8033e6e96cfe28d82f49dc；app/repository/member_balance_repo.py=4963cf901dc29e06be75940c0bf8b73ba75cc659b407897449f321ce346b9df2；app/repository/refund_shortfall_debt_repo.py=1ad5089b650e6541c697319482db45e6ac0884b3e1d404251ddb7107f0c89b58；app/repository/ledger_operation_repo.py=48431baf50810f7652dc0ac94b5b2669d0f322022dbf6669cd6ec3904a12e2ad；app/service/payment/unified.py=56b3832e6cd22a0570bfd927176a210401178857f03c05c1c3e9c4c4c60c4ccd；app/service/points/ledger.py=b7a495b1c1fdc33674997b2ae9527407d25b8550df5769603918b7827f7a820d；app/service/points/payment.py=a86e89c81f1bf4a135579fa56067b0fe6d433324059280ca5b59e130f5e010af；app/service/order/payment_runtime.py=4d69037a96eb48281cdc51adc326434abf7647e4cad5fc543cbc559119467fc9；app/service/order/cancellation.py=6a2ed6dbb00788a8dddbf5ef39a8272e63c2b60db9b62e739a6e1a7b854c4dcb；app/service/order/status_flow.py=be11288b56e8111f2a9e96df1bb55448060a2d9a7709ee5f1729e4c04e8827d1；app/service/order/expiration.py=d4412bf4f38478eda67932bbdc1d384a51a09608ae2c12296d99c39ab0bb421b；app/service/stored_value/payment.py=e381038e91548c3d9821f2fc3b11440781e26a6e8cb5ffc5757f2904dddab897；scripts/check_project.py=f8f8509afec17ce5ba8dcf69734a4afb3c4484bda3129c62794bf10936fa034d；scripts/check_file_sizes.py=ec77a7e5915867984d2605694e4878e656f9c93107056264901605d3a441d216；tests/service/test_payment_attempt_d1a.py=d69653f4df34114a63959991429d841b7e0ec0805c9f35858205a61b868b211c；tests/service/test_points_payment.py=3c8fec16f18fbd188f66d6d997f5cc9668a2cdd42ab6b7ecdfeb524922088876
- summary: D1-A 最小资金核心纵向切片开发测试（G0 后项目负责人明确指示「启动 D1-A 的开发测试」；真实支付/真实券/正式导入/真实用户开放/权威切换保持 No-Go）：v027 迁移（payment_attempt（subject-slot 部分唯一索引含 manual_review）/ payment_attempt_leg / account_hold / accounting_outbox + refund_shortfall_debt 增 remaining/version 回填）+ 三个新仓储（attempt 状态 CAS 机、hold、outbox 租约与依赖 fail-closed）；UnifiedPaymentApplicationService（settle_mock_order 状态 CAS 幂等/重放、release_order_holds 取消/超时释放、mark_manual_review；attempt=结算命令事实源+幂等源，order.payment 仍为展示缓存）；confirm_mock_payment / pay_order_with_balance 以 settle_actions 闭包走统一服务；四类取消/超时入口统一释放；points 全链路按不可变 member_balance_id（redeem/award/clawback/refund，账户删除重建禁止按手机号新建替代账户 → account_missing 案件 + 欠账）；_repay_open_debts 入账优先偿债（version CAS、open→settled、refund_debt_repay ledger_operation 事实）；check_project D1-0 守卫登记统一服务与新写面（18→19 模块 + 方法级 allowlist + 显式写方法补全 + 闭包归外层方法修复）。A1–A6 六项验收测试全部可复现；全量 1520 项通过。ADR 0008 仍为 proposed（D1-A 仅批准开发测试能力）；master 双远端保持 b30b2066；不部署、不开放资产写操作；2027-05-31 开发测试边界不变；时钟偏差留档（G0）继续适用（提交时间 2026-08-16 为可信时间源，不 amend 已归档提交）。
